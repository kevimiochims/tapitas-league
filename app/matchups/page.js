...
function getPlayerHeadshot(name, playerLookup) {
                      ...
                      return (
                        <React.Fragment key={i}>
                          ...
                          <div className="grid grid-cols-[1fr_60px_1fr] gap-1 md:gap-2 mb-2 items-center">
                            ...
                            {/* Ajustado: px-2 no mobile, text-xs no mobile, min-w-0 para o truncate funcionar */}
                            <div className={`flex items-center justify-between rounded-2xl px-2 md:px-4 py-3 min-w-0 gap-1.5 ${away ? 'bg-white/[0.03] border border-white/5' : 'opacity-0'}`}>
                      ...
                      return (
                        <React.Fragment key={i}>
                          <div className="grid grid-cols-[1fr_60px_1fr] gap-1 md:gap-2 mb-2 items-center">
                            ...
                            <div className={`flex items-center justify-between rounded-2xl px-2 md:px-4 py-3 min-w-0 gap-1.5 ${away ? 'bg-white/[0.02] border border-white/[0.03]' : 'opacity-0'}`}>
